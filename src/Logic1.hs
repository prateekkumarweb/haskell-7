module Logic1 where
   ...
   ---------------------------------------------------
    ...
    horizontalLineUnblock :: Game -> [Int] -> Cell
    ...
    verticleLineUnblock :: Game -> [Int] -> Cell
    ...
    -- | 'botMoveThree'
    --  This Function 'botMove' to check that this empty postion is where a morris can be formed
